...
class SearchAdapter(var items: ArrayList<GifImage>, private val onItemClick: (gifImage: GifImage?) -> Unit) :
    ...
    fun updateData(newList: ArrayList<GifImage>) {
        items.clear()
        items.addAll(newList)
        notifyDataSetChanged()
    }

    fun insertData(newList: ArrayList<GifImage>) {
